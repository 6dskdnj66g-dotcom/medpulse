      ...
      <header className="border-b border-[var(--border-subtle)] bg-[var(--bg-0)]/80 backdrop-blur-md">
        <div className="max-w-5xl mx-auto px-4 md:px-8 py-6 md:py-8">
          ...
          <p className="mt-2 text-sm text-[var(--text-secondary)] font-medium max-w-2xl leading-relaxed">
            {isAr
              ? "دليل مُنسّق للكليات الطبية العراقية، المراجع الأكاديمية الأساسية، والإرشادات السريرية العراقية والعالمية، والتطبيقات الطبية الرقمية."
              : "A curated directory of Iraqi medical colleges, core academic references used across MBChB curricula, clinical guidelines from Iraqi and international bodies, and the medical apps most relevant to students in Iraq."}
          </p>
        </div>
      </header>
